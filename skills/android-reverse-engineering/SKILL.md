...
This skill requires **Java JDK 17 or higher+** and **jadx** to be installed. **Fernflower/Vineflower** and **dex2jar** are optional but recommended for better decompilation quality. Run the dependency checker to verify:

```bash
bash ~/.pi/agent/skills/android-reverse-engineering/scripts/check-deps.sh
```

If anything is missing, follow the installation instructions in `~/.pi/agent/skills/android-reverse-engineering/references/setup-guide.md`.
...
```bash
bash ~/.pi/agent/skills/android-reverse-engineering/scripts/install-dep.sh <dep>
```
...
```bash
bash ~/.pi/agent/skills/android-reverse-engineering/scripts/decompile.sh [OPTIONS] <file>
```
...
See `~/.pi/agent/skills/android-reverse-engineering/references/jadx-usage.md` and `~/.pi/agent/skills/android-reverse-engineering/references/fernflower-usage.md` for the full CLI references.
...
See `~/.pi/agent/skills/android-reverse-engineering/references/call-flow-analysis.md` for detailed techniques and grep commands.
...
```bash
bash ~/.pi/agent/skills/android-reverse-engineering/scripts/find-api-calls.sh <output>/sources/
```

Targeted searches:
```bash
# Only Retrofit
bash ~/.pi/agent/skills/android-reverse-engineering/scripts/find-api-calls.sh <output>/sources/ --retrofit

# Only hardcoded URLs
bash ~/.pi/agent/skills/android-reverse-engineering/scripts/find-api-calls.sh <output>/sources/ --urls

# Only auth patterns
bash ~/.pi/agent/skills/android-reverse-engineering/scripts/find-api-calls.sh <output>/sources/ --auth
```
...
See `~/.pi/agent/skills/android-reverse-engineering/references/api-extraction-patterns.md` for library-specific search patterns and the full documentation template.
...
- `~/.pi/agent/skills/android-reverse-engineering/references/setup-guide.md` — Installing Java, jadx, Fernflower/Vineflower, dex2jar, and optional tools
- `~/.pi/agent/skills/android-reverse-engineering/references/jadx-usage.md` — jadx CLI options and workflows
- `~/.pi/agent/skills/android-reverse-engineering/references/fernflower-usage.md` — Fernflower/Vineflower CLI options, when to use, APK workflow
- `~/.pi/agent/skills/android-reverse-engineering/references/api-extraction-patterns.md` — Library-specific search patterns and documentation template
- `~/.pi/agent/skills/android-reverse-engineering/references/call-flow-analysis.md` — Techniques for tracing call flows in decompiled code
